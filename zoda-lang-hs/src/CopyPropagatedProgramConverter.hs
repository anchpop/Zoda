...
createMapOfIdentifiersToValues :: Module p -> Either (ProductionError p) (Map.Map Text (Expression p))
...
checkNoUndefinedIdentifiers :: (Map.Map Text (Expression p)) -> Either (ProductionError p) (Map.Map Text (Expression p))
...
checkHasMain :: Module p -> (Map.Map Text (Expression p)) -> Either (ProductionError p) (Map.Map Text (Expression p))
