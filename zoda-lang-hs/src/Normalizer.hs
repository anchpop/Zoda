...
type Constraints m i' = (Bindable m, Ord m, Show m, NominalShow m, Bindable i', Ord i', Show i', NominalShow i')
...
do_snd :: (Constraints m i') => JustifiedModule () () ph m () i' -> Semantic () () (Map.Key ph m) () i' -> Semantic () () (Map.Key ph m) () i'
...
do_ap :: (Constraints m i') => JustifiedModule () () ph m () i' -> Semantic () () (Map.Key ph m) () i' -> Semantic () () (Map.Key ph m) () i' -> Semantic () () (Map.Key ph m) () i'
...
do_clos :: forall m ph i i'. (Constraints m i')
...
eval :: forall ph m i i'. (Constraints m i') => JustifiedModule () () ph m () i' -> Expression () () (Map.Key ph m) () -> SemanticEnv () () (Map.Key ph m) () i' -> Semantic () () (Map.Key ph m) () i'
eval modu = eval'
  where 
...
--   - one for types. 
read_back_nf :: (Constraints m i') => JustifiedModule () () ph m () i' ->  Nf () () (Map.Key ph m) () i' -> Expression () () (Map.Key ph m) ()
...
read_back_tp :: forall m ph i i'. (Constraints m i') => JustifiedModule () () ph m () i' -> Semantic () () (Map.Key ph m) () i' -> Expression () () (Map.Key ph m) ()
...
read_back_ne :: forall m ph i i'.  (Constraints m i') => JustifiedModule () () ph m () i' -> Ne () () (Map.Key ph m) () i' -> Expression () () (Map.Key ph m) ()
...
make_initial_env :: forall ph m i i'. (Constraints m i') => JustifiedModule () () ph m () i' -> [(Atom, Expression () () (Map.Key ph m) ())] -> SemanticEnv () () (Map.Key ph m) () i'
make_initial_env _    [] = []
...
normalize :: forall t p i i' ph m. (Bindable t, Bindable p, Bindable i, Constraints m i') => JustifiedModule t p ph m i i' -> SurfaceEnv t p (Map.Key ph m) i -> Expression t p (Map.Key ph m) i -> Expression t p (Map.Key ph m) i -> Expression () () (Map.Key ph m) ()
...
normalizeType :: forall t p i i' ph m. (Bindable t, Bindable p, Bindable i, Constraints m i') => JustifiedModule t p ph m i i' -> SurfaceEnv t p (Map.Key ph m) i -> Expression t p (Map.Key ph m) i -> Expression () () (Map.Key ph m) ()
